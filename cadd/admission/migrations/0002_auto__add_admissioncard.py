...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdmissionCard'
        db.create_table(u'admission_admissioncard', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admission.Student'], null=True, blank=True)),
        ))
        db.send_create_signal(u'admission', ['AdmissionCard'])

    def backwards(self, orm):
        # Deleting model 'AdmissionCard'
        db.delete_table(u'admission_admissioncard')

    models = {
        u'admission.admissioncard': {
            'Meta': {'object_name': 'AdmissionCard'},
