...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Installment.order'
        db.add_column(u'admission_installment', 'order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Installment.order'
        db.delete_column(u'admission_installment', 'order')
