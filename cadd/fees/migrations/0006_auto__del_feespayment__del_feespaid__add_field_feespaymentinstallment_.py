...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeesPaymentInstallment.receipt_no'
        db.add_column(u'fees_feespaymentinstallment', 'receipt_no',
        ...
        # Adding field 'FeesPaymentInstallment.paid_fine_amount'
        db.add_column(u'fees_feespaymentinstallment', 'paid_fine_amount',
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'fees_feespaid', (
            ...
            ('fees_payment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.FeesPayment'], null=True, blank=True)),
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receipt_no', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'fees', ['FeesPaid'])

        # Deleting field 'FeesPaymentInstallment.receipt_no'
        db.delete_column(u'fees_feespaymentinstallment', 'receipt_no')

        # Deleting field 'FeesPaymentInstallment.paid_date'
        db.delete_column(u'fees_feespaymentinstallment', 'paid_date')

        # Deleting field 'FeesPaymentInstallment.paid_fine_amount'
        db.delete_column(u'fees_feespaymentinstallment', 'paid_fine_amount')
    ...
    models = {
        ...
        u'fees.feespaymentinstallment': {
            ...
            'next_fees_payment_installment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fees.FeesPaymentInstallment']", 'null': 'True', 'blank': 'True'}),
