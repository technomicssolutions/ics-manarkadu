...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeesPaymentInstallment.fee_waiver_amount'
        db.add_column(u'fees_feespaymentinstallment', 'fee_waiver_amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=14, decimal_places=2),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeesPaymentInstallment.fee_waiver_amount'
        db.delete_column(u'fees_feespaymentinstallment', 'fee_waiver_amount')
