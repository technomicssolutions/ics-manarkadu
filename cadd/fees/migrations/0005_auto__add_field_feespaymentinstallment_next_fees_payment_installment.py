...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeesPaymentInstallment.next_fees_payment_installment'
        db.add_column(u'fees_feespaymentinstallment', 'next_fees_payment_installment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.FeesPaymentInstallment'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeesPaymentInstallment.next_fees_payment_installment'
        db.delete_column(u'fees_feespaymentinstallment', 'next_fees_payment_installment_id')
    ...
    models = {
        ...
        u'fees.feespaid': {
            ...
            'fees_payment': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fees.FeesPayment']", 'null': 'True', 'blank': 'True'}),
