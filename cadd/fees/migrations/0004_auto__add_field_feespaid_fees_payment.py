...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeesPaid.fees_payment'
        db.add_column(u'fees_feespaid', 'fees_payment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fees.FeesPayment'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'FeesPaid.fees_payment'
        db.delete_column(u'fees_feespaid', 'fees_payment_id')
