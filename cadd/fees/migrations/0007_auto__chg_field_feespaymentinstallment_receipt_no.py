...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FeesPaymentInstallment.receipt_no'
        db.execute(
            'ALTER TABLE "fees_feespaymentinstallment" '
            'ALTER COLUMN "receipt_no" DROP DEFAULT, '
            'ALTER COLUMN "receipt_no" DROP NOT NULL, '
            'ALTER COLUMN "receipt_no" TYPE INTEGER '
            'USING (trim(receipt_no)::integer);'
        ) 
        #db.alter_column(u'fees_feespaymentinstallment', 'receipt_no', self.gf('django.db.models.fields.IntegerField')(default=1))
    def backwards(self, orm):

        # Changing field 'FeesPaymentInstallment.receipt_no'
        db.alter_column(u'fees_feespaymentinstallment', 'receipt_no', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
    models = {
        u'admission.enquiry': {
        ...
        u'fees.feespaymentinstallment': {
            ...
            'receipt_no': ('django.db.models.fields.IntegerField', [], {}),
